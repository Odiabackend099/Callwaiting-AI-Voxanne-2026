...
async function testMarkAsBooked() {
...
async function testBookingConfirmButton() {
  ...
  return response.status === 200 && response.confirmation_status === 'confirmed';
}

async function testSendSMSButton() {
...
async function testLeadStatusButton() {
  ...
  return response.status === 200 && response.updated_count === 2;
}
...
async function testReserveAtomic() {
...
async function testVerifyOTP() {
  ...
  return response.status === 200 && response.otp_verified === true;
}
