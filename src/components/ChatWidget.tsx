...
export const ChatWidget = () => {
    ...
    const [messages, setMessages] = useState<{ role: "bot" | "user" | "system"; text: string }[]>([
        { role: "bot", text: "Hi there! 👋 I'm Roxanne. I can answer calls, book appointments, and handle FAQs for your clinic 24/7." },
                        ...
                        <div className="bg-gradient-to-r from-cyan-600 to-blue-600 p-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="relative w-10 h-10 rounded-full bg-white/20 flex items-center justify-center overflow-hidden border-2 border-white/30">
                                    <Image src="/callwaiting-ai-logo.png" alt="Roxanne" width={40} height={40} className="object-contain" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-white text-sm">Roxanne AI</h3>
