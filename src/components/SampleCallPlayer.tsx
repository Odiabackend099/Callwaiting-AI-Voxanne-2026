                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg">
                            Hear Call Waiting AI handle a BBL inquiry from start to booking.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-black/30 rounded-2xl p-6 border border-white/5">
                            ...
                            <div className="space-y-4 text-sm">
                                <div>
                                    <span className="text-cyan-400 font-medium">Call Waiting AI:</span>
                                    <span className="text-slate-300 ml-2">
                                        "Good afternoon, you've reached Dr. Chen's cosmetic surgery practice. This is Call Waiting AI. How may I assist you today?"
                                    </span>
                                </div>
                                <div>
