...
const testimonials = [
    {
        ...
        quote: "Roxanne paid for herself in the first month. We're now capturing every single after-hours BBL inquiry that we used to miss.",
        ...
        <section className="py-24 bg-gradient-to-b from-black to-slate-950">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    >
                        Real doctors, real results. Watch how Roxanne transformed their practices.
                    </motion.p>
                </div>
