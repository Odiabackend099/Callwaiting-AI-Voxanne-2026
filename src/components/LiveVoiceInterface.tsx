            ...
            <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-900">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-slate-300">
                        {isTalking ? "Call Waiting AI is listening..." : "Call Waiting AI is ready"}
                    </span>
                </div>
                        ...
                        >
                            ...
                            >
                                <span className="block text-[10px] opacity-70 mb-1 font-bold uppercase tracking-wider">
                                    {msg.role === "ai" ? "Call Waiting AI AI" : "Caller"}
                                </span>
                                {msg.text}
                            </div>
                        </motion.div>
                ...
                {typingText && (
                    ...
                    >
                        <div className={`max-w-[80%] px-5 py-3 rounded-2xl text-sm leading-relaxed shadow-lg opacity-80 ${conversationFlow[transcript.length % conversationFlow.length]?.role === "ai"
                            ...
                            <span className="block text-[10px] opacity-70 mb-1 font-bold uppercase tracking-wider">
                                {conversationFlow[transcript.length % conversationFlow.length]?.role === "ai" ? "Call Waiting AI AI" : "Caller"}
                            </span>
                            {typingText}
