...
export default function HowItWorksRedesigned() {
    return (
        <section id="how-it-works" className="relative py-20 md:py-32 bg-gradient-to-b from-sage to-cream overflow-hidden">
            {/* Background Elements */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-blue-deep/5 rounded-full blur-[120px]" />
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                        ...
                        >
                            ...
                            >
                                ...
                                {index < steps.length - 1 && (
                                    <div className="absolute left-6 top-20 w-1 h-24 bg-gradient-to-b from-blue-deep via-cyan to-lime opacity-30" />
                                )}

                                {/* Step Number Circle */}
                                <div className={`flex-shrink-0 w-12 h-12 rounded-full ${step.color} text-cream flex items-center justify-center font-display font-bold text-lg`}>
                                    {step.number}
                                </div>
                ...
                <FadeInOnScroll>
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="mt-16 bg-cream-light border border-sage-dark rounded-lg p-8 md:p-12"
                    >
                        <h3 className="text-2xl font-bold text-charcoal mb-8">Why It Works</h3>
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={index} className="flex gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-lime flex-shrink-0 mt-1" />
                                    <p className="text-charcoal/70">{benefit}</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
