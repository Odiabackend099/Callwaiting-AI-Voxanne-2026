                    ...
                    <div className="flex-1 relative">
                        ...
                        <div className="mt-12 p-8 rounded-3xl bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-500/20">
                            ...
                            <p className="text-slate-300 text-center mb-6">
                                Control Roxanne from your phone with our iOS and Android apps. Monitor calls, update settings, and respond to leads on the go.
                            </p>
                            ...
                            <p className="text-slate-400 text-sm text-center mt-4">
                                Get instant notifications when Roxanne books a consultation or needs your attention
                            </p>
                        </div>
                    </div>
                </div>
