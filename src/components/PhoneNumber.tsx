 ...
 * Displays the Call Waiting AI AI phone number with click-to-dial functionality
 *
 * Variants:
  ...
  if (variant === 'button') {
    return (
      <button
        ...
        aria-label="Call Call Waiting AI"
      >
        <Phone size={18} />
        Call Now
      </button>
    ...
    <div className={`bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg shadow-lg ${widgetSizeClasses[size]}`}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs opacity-75 mt-1">
              Instant AI Demo • Speak to Call Waiting AI
            </p>
          </div>
        </div>
      ...
      <div className="mt-4 pt-4 border-t border-white border-opacity-20">
        <p className="text-xs opacity-75">
          ✨ Powered by Call Waiting AI • Deepgram Flux • Groq LLama 3.3-70B
        </p>
      </div>
    </div>
  );
...
export function usePhoneNumber() {
  return {
    ...
    displayName: 'Call Waiting AI',
    availableTime: '24/7',
    getDisplayText: () => `Call ${PHONE_NUMBER} to speak with Call Waiting AI`,
