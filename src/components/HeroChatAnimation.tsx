...
const sequence: Message[] = [
    ...
    { id: 4, role: "user", text: "Great! Also, is my data secure? HIPAA compliant?", icon: User, delay: 6000 },
    { id: 5, role: "ai", text: "Absolutely. We are fully HIPAA compliant and all data is encrypted. 🔒", icon: ShieldCheck, delay: 8000 },
