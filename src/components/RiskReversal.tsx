                ...
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-cyan-900/20 to-blue-900/20 border border-cyan-500/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                            Try Voxanne AI in your clinic for 30 days. If she doesn&apos;t capture at least <strong className="text-white">one new patient booking</strong> that you would have otherwise missed, we will refund 100% of your subscription.
                        </p>
