        ...
        <section className="py-12 border-y border-white/5 bg-black/40 backdrop-blur-sm overflow-hidden relative z-10">
            <div className="container mx-auto px-6">
                ...
                <div className="mt-10 text-center">
                    <p className="text-zinc-300 italic font-medium text-lg">&quot;Since installing Voxanne AI, our after-hours consult bookings increased by 40%. She paid for herself in the first week.&quot;</p>
