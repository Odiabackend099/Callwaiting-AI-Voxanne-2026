...
const faqData: FAQCategory[] = [
    {
        ...
        icon: ShieldCheck,
        items: [
            { question: "Is CALL WAITING AI LTD HIPAA compliant?", answer: "Yes, CALL WAITING AI LTD is built with enterprise-grade security and is fully HIPAA compliant. We sign a BAA (Business Associate Agreement) with every medical practice." },
            { question: "Does she store patient data?", answer: "CALL WAITING AI LTD only temporarily processes data needed for booking (name, reason for visit). All data is encrypted in transit and at rest, adhering to strict privacy standards." },
            { question: "Can she handle medical emergencies?", answer: "CALL WAITING AI LTD is trained to recognize emergency keywords (e.g., 'bleeding', 'pain', 'breathing'). She immediately routes these calls to your emergency line or instructs the patient to hang up and dial 911/999." },
            { question: "What about liability if she makes a mistake?", answer: "CALL WAITING AI LTD operates within your strict guardrails. If she is unsure, she executes a 'Human Escalation Protocol' to transfer the call or take a message. All calls are recorded for your review and liability protection." }
        ]
    },
    {
        ...
        icon: Stethoscope,
        items: [
            { question: "Does CALL WAITING AI LTD understand BBL, Mommy Makeover, etc.?", answer: "Yes. CALL WAITING AI LTD is pre-trained on 500+ cosmetic and medical procedures, from BBLs and Rhinoplasties to CoolSculpting and Mohs surgery." },
            ...
            { question: "What if a patient asks about recovery time?", answer: "CALL WAITING AI LTD delivers your approved clinical answers. For example: 'Dr. Chen typically advises 2 weeks off work for a tummy tuck.'" },
            { question: "Can she handle insurance questions?", answer: "CALL WAITING AI LTD can answer basic network questions ('Do you take Blue Cross?') and route complex billing inquiries directly to your billing coordinator." }
        ]
    },
    {
        ...
        items: [
            ...
            { question: "How long is setup?", answer: "Because CALL WAITING AI LTD is pre-trained on medical workflows, we can go live in as little as 48 hours after your 15-minute onboarding call." },
    ...
    },
    {
        ...
        icon: TrendingUp,
        items: [
            { question: "Does she replace my receptionist?", answer: "No. CALL WAITING AI LTD handles the 'busy work'—overflow calls, after-hours inquiries, and FAQ. This frees your front desk to focus on the high-value patients in front of them." },
