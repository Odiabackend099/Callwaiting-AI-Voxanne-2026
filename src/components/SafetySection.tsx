            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-400 max-w-2xl mx-auto text-lg">
                        Voxanne is the only AI receptionist with &quot;Safe Mode&quot; — a breakdown-proof protocol that prevents medical liability while capturing revenue.
                    </p>
                </div>

                {/* Safe Mode Logic Visualization */}
                <div className="max-w-5xl mx-auto bg-slate-900/50 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-sm relative mb-20">
                    ...
                    {[
                        {
                            ...
                            desc: "Voxanne is hardcoded to never diagnose or prescribe. She deflects medical questions to your team 100% of the time.",
