            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto">
                        One missed rhinoplasty covers Voxanne for 5 years. Stop stepping over dollars to pick up pennies.
                    </p>
                </div>
                ...
                <div className="mt-16 text-center">
                    <p className="text-slate-500 text-sm flex items-center justify-center gap-2">
                        ...
                        <span>Compare to average UK receptionist salary: <strong>£24,500/yr</strong> vs. Voxanne <strong>£5,964/yr</strong></span>
                    </p>
                </div>
            </div>
        </section>
