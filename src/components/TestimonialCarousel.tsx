...
const testimonials: Testimonial[] = [
    {
        ...
        quote: "Voxanne isn't just an answering service. She captured roughly $120k in missed revenue in the first month alone. I can't imagine running my practice without her now.",
    ...
    },
    {
        ...
        quote: "Our front desk was overwhelmed. Voxanne took over 80% of the call load instantly. Our patient satisfaction scores went up because humans could focus on the people in the room.",
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto">
                        See how top practices are using Voxanne to grow revenue and delight patients.
                    </p>
                </div>
