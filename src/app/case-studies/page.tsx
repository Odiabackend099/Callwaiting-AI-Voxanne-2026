...
export const metadata: Metadata = {
    ...
    description: "Real results from medical practices using Call Waiting AI AI receptionist",
};
...
const caseStudies = [
    {
        ...
        quote: "Call Waiting AI paid for herself in the first month. We're now capturing every single after-hours BBL inquiry.",
    ...
    },
    {
        ...
        quote: "The British accent was crucial for our clientele. Call Waiting AI sounds more professional than our previous receptionist.",
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-slate-950 to-black border-b border-white/5">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <p className="text-xl text-slate-400">
                        See how medical practices are using Call Waiting AI to capture more leads and increase revenue.
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 px-6 border-t border-white/5">
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-slate-400 mb-8">
                        Book a demo and see how Call Waiting AI can transform your practice.
                    </p>
