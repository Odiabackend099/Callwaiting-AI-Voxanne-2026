...
export const metadata: Metadata = {
    ...
    description: "Real results from medical practices using CALL WAITING AI LTD AI receptionist",
};
...
const caseStudies = [
    {
        ...
        quote: "CALL WAITING AI LTD paid for herself in the first month. We're now capturing every single after-hours BBL inquiry.",
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-slate-950 to-black border-b border-white/5">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <p className="text-xl text-slate-400">
                        See how medical practices are using CALL WAITING AI LTD to capture more leads and increase revenue.
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 px-6 border-t border-white/5">
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-slate-400 mb-8">
                        Book a demo and see how CALL WAITING AI LTD can transform your practice.
                    </p>
