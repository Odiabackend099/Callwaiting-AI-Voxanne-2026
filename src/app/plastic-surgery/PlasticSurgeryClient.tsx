        ...
        <SmoothScroll>
            <main className="min-h-screen bg-black text-white selection:bg-purple-500/30">
                ...
                <Hero
                    ...
                    subtitle={
                        <>
                            Capture the 40% of leads that call after-hours. Roxanne qualifies surgical candidates, <br />
                    ...
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-8 md:p-12">
                            ...
                            <p className="mt-8 text-lg text-slate-300 italic">
                                &quot;Roxanne pays for herself in the first 3 days of the month. She handles all the &apos;Are you open?&apos; calls so my coordinator can focus on closing surgeries.&quot;
                            </p>
