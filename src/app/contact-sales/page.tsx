      ...
      <section className="py-20 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 space-y-4">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Share your call volume, calendar/EHR stack, and goals. We’ll configure a tailored demo,
        ...
        <div className="max-w-4xl mx-auto px-6 grid md:grid-cols-2 gap-10">
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-slate-700 text-sm leading-relaxed list-disc list-inside">
              ...
              <li>Integration walkthrough for calendars (Google/Outlook), EHR, and CRM.</li>
