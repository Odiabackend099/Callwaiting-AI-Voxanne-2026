...
export async function POST(request: NextRequest) {
    try {
        ...
        // With Roxanne (98% call answer rate - industry-leading)
        const withRoxanneMissed = Math.round(missedCallsPerMonth * 0.02);
        const withRoxanneRevenueSaved = Math.round((missedCallsPerMonth - withRoxanneMissed) * avgProcedureValue * conversionRate);
        const yearlyRevenueSaved = withRoxanneRevenueSaved * 12;
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; background-color: #f0fdf4;">
                            <h2 style="margin: 0 0 20px 0; color: #0f172a; font-size: 24px; font-weight: 700;">✨ With Roxanne AI</h2>
                            ...
                            <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 30px; border-radius: 12px; margin-bottom: 20px; text-align: center;">
                                ...
                                <p style="margin: 0; color: #ffffff; font-size: 48px; font-weight: 700;">$${withRoxanneRevenueSaved.toLocaleString()}</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="50%" style="padding-left: 10px;">
                                        <div style="background-color: #ffffff; border: 2px solid #10b981; padding: 20px; border-radius: 8px; text-align: center;">
                                            <p style="margin: 0 0 5px 0; color: #065f46; font-size: 12px; font-weight: 600;">MISSED CALLS</p>
                                            <p style="margin: 0; color: #047857; font-size: 24px; font-weight: 700;">Only ${withRoxanneMissed}/mo</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 40px 30px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); text-align: center;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #cbd5e1; font-size: 16px;">Book a demo and see Roxanne in action</p>
