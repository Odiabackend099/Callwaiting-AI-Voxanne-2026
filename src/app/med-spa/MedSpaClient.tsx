...
export default function MedSpaPage() {
    ...
    const medSpaFeatures = [
        ...
        },
        {
            ...
            description: "While you're closed Sunday, Call Waiting AI books your Monday solid. Captures the high volume of weekend inquiries."
        },
        {
            icon: Gem,
        ...
        <SmoothScroll>
            <main className="min-h-screen bg-black text-white selection:bg-purple-500/30">
                ...
                <Hero
                    ...
                    subtitle={
                        <>
                            Stop losing weekend revenue to voicemail. Call Waiting AI answers instantly, explains your memberships, <br />
                    ...
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-8 md:p-12">
                            ...
                            <p className="mt-8 text-lg text-slate-300 italic">
                                &quot;Our injectors used to spend hours calling people back. Now they just come in and inject. Call Waiting AI fills the books automatically.&quot;
                            </p>
