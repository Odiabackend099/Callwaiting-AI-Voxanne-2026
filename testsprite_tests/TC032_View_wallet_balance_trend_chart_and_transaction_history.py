...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with ceo@demo.com / demo123 and click the 'Sign In' button to log in, then verify dashboard and navigate to Wallet.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Fill the email and password fields with ceo@demo.com / demo123 and click the 'Sign In' button to attempt to reach the dashboard.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[1]/div[1]/div/form/div[1]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('ceo@demo.com')
