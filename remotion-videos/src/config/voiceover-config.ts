...
export const SCENE_VOICEOVERS: SceneVoiceover[] = [
  ...
  {
    sceneId: 'scene-1',
    sceneName: 'Zero to Hero (Homepage to Dashboard)',
    durationSeconds: 10,
    script: "The modern clinic is drowning in missed calls. Meet Voxanne. Your front desk, evolved. Let's build your first agent.",
    voiceId: RACHEL_VOICE_ID,
    modelId: DEFAULT_MODEL_ID,
    wpmTarget: 132,
  },
  {
    sceneId: 'scene-2-birth',
    sceneName: 'The Birth (Create Agent)',
    durationSeconds: 8,
    script: "Deploying an AI receptionist takes seconds. Meet Aura. Context-aware, empathetic, and ready to work 24/7.",
    voiceId: RACHEL_VOICE_ID,
    modelId: DEFAULT_MODEL_ID,
    wpmTarget: 120,
  },
